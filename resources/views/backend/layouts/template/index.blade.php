            ...
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm"><a class="has-arrow" href="javascript:void()"
                            aria-expanded="false">
                            <i class="mdi mdi-page-layout-body"></i><span class="nav-text">Layouts</span><span
                    ...
                    <li class="mega-menu mega-menu-lg"><a class="has-arrow" href="javascript:void()"
                            aria-expanded="false"><i class="mdi mdi-chart-bar"></i> <span class="nav-text">Charts</span>
                            <span class="badge badge-primary nav-badge">19</span></a>
                        <ul aria-expanded="false">
                                ...
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-info">2,02,150</h2><span class="">Total
                                                Orders</span>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-danger">2,02,150</h2><span class="">Total
                                                Orders</span>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-warning">2,02,150</h2><span class="">Total
                                                Orders</span>
                                        </div>
                                        ...
                                        <div class="map-coruntry-list">
                                            ...
                                            <ul>
                                                <li><a href="javascript:void()"><i
                                                            class="fa fa-circle-o text-success"></i> Canada
                                                        <span>55%</span></a>
                                                </li>
                                                <li><a href="javascript:void()"><i
                                                            class="fa fa-circle-o text-warning"></i> Brasil
                                                        <span>60%</span></a>
                                                </li>
                                                <li><a href="javascript:void()"><i class="fa fa-circle-o text-info"></i>
                                                        Russia <span>18%</span></a>
                                                </li>
                                                <li><a href="javascript:void()"><i
                                                            class="fa fa-circle-o text-secondary"></i> Egypt
                                                        <span>20%</span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <table class="table table-padded recent-order-list-table table-responsive-fix-big">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span
                                                        class="label label-xl label-rounded label-success">Delivered</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>03</td>
                                                ...
                                                <td><span
                                                        class="label label-xl label-rounded label-danger">Cancel</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>04</td>
                                                ...
                                                <td class="text-muted">04 May 2018, 10:30 AM</td>
                                                <td><a href="javascript:void()" class="text-primary">Hrasnoyarsk</a>
                                                </td>
